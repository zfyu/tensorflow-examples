...
if __name__ == '__main__':
	...
	parser.add_argument('--data_dir',type=str,default='MNIST_data/',help='Directory for storing data')

	parser.add_argument('--summaries_dir',type=str,default='mnist_logs/',help='Summaries directory')
